...
val surface_container = Color(0xFFEDEEF0)

// Custom semantic colors for Forms
val formSectionBackgroundLight = Color(0xFFF5F5F5)
val formSectionBackgroundDark = Color(0xFF2C2C2C) // Neutral dark gray for form section backgrounds
val formDividerLight = Color(0xFFE0E0E0)
val formDividerDark = Color(0xFF424242)     // Neutral dark gray for dividers


val seed = Color(0xFF0099CE)
val tertiary95 = Color(0xFFFFEFCC)
val checkGreen = Color(0xFF24B400)
val time_tracker_green = Color(0xFF21A700)
val redColor = Color(0xFFD61D28)
val buttonDisableBg = Color(0xFFe3e3e4)
val specialTaskColor = Color(0xFFC9B8E9)
val specialTaskBackground = Color(0x66C9B8E9)
