...
import it.airbagstudio.ticare.pages.patientDetails.form.domain.model.IPOS7ggSection // Changed import
import it.airbagstudio.ticare.pages.patientDetails.form.domain.model.QuestionResponse

object IPOS7ggQuestions { // Changed object name

    // Unique Question IDs (remain the same)
    ...
    val formTitle = "Scala IPOS – 7gg (Italian Palliative care Outcome Scale – 7-day version)"
    val formIntroText = "Istruzioni per la compilazione: si prega di rispondere alle seguenti domande in base a quanto sperimentato nell’ultima settimana."
    val q1IntroText = "Please list the three main problems or concerns experienced by the patient over the last 7 days:"
    val q2IntroText = "Rate the following symptoms based on how much they disturbed the patient over the last 7 days:"
    ...
    val initialSections: List<IPOS7ggSection> = listOf( // Changed to IPOS7ggSection
        IPOS7ggSection( // Changed to IPOS7ggSection
            sectionId = "Q1",
            title = "Q1 – Problemi o preoccupazioni principali", // Textual content for Q1 title
            questions = listOf(
        ...
        IPOS7ggSection( // Changed to IPOS7ggSection
            sectionId = "Q2b",
            title = "Q2b – Sintomi aggiuntivi (campo + scala da 0 a 4)", // Textual content for Q2b title
            questions = listOf(
        ...
        IPOS7ggSection( // Changed to IPOS7ggSection
            sectionId = "Q3_Q9",
            title = "Q3 a Q9 – Stato emotivo, relazionale, spirituale e pratico (Scala da 0 a 4)", // Textual content for Q3-Q9 title
            questions = listOf(
        ...
        IPOS7ggSection( // Changed to IPOS7ggSection
            sectionId = "Q10",
            title = "Q10 – Modalità di compilazione del questionario", // Textual content for Q10 title
            questions = listOf(
    ...
    val q10Options: List<String> = listOf( // Remains the same
        "Da solo",
