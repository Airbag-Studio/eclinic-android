...
import it.airbagstudio.ticare.pages.patientDetails.form.domain.model.IPOSSection
...
object IPOSQuestions {

    // Unique Question IDs (same as existing forms)
    ...
    fun getFormTitle(timePeriod: IPOSTimePeriod): String {
        return when (timePeriod) {
            IPOSTimePeriod.DAYS_3 -> "Scala IPOS – 3gg"
            IPOSTimePeriod.DAYS_7 -> "Scala IPOS – 7gg"
        }
    }

    fun getInitialSections(timePeriod: IPOSTimePeriod): List<IPOSSection> {
        return listOf(
            IPOSSection(
                sectionId = "Q1",
                ...
                questions = listOf(
                    ...
                    QuestionResponse(questionId = Q1_CONCERN_3_ID, questionText = "")
                )
            ),
            IPOSSection(
                sectionId = "Q2",
            ...
            IPOSSection(
                ...
                questions = listOf(
                    ...
                    QuestionResponse(questionId = Q2B_ADDITIONAL_SYMPTOM_3_ID, questionText = "")
                )
            ),
            IPOSSection(
                sectionId = "Q3_Q9",
            ...
            IPOSSection(
                ...
                questions = listOf(
                    QuestionResponse(questionId = Q10_MODALITA_COMPILAZIONE_ID, questionText = "Modalità di compilazione")
                )
            )
        )
    }
